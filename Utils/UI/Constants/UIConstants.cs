...
namespace EfDEnhanced.Utils.UI.Constants
{
    ...
    public static class UIConstants
    {
        ...
        /// 任务标题颜色（金黄色）
        /// </summary>
        public static readonly Color QUEST_TITLE_COLOR = new Color(1f, 0.9f, 0.4f, 1f);
        
        /// <summary>
        /// 任务描述颜色（浅灰色）
        /// </summary>
        public static readonly Color QUEST_DESC_COLOR = new Color(0.85f, 0.85f, 0.85f, 1f);
        
        /// <summary>
        /// 任务完成颜色（绿色）
        /// </summary>
        public static readonly Color QUEST_COMPLETE_COLOR = new Color(0.6f, 1f, 0.6f, 1f);
        
        /// <summary>
        /// 任务未完成颜色（白色）
        /// </summary>
        public static readonly Color QUEST_INCOMPLETE_COLOR = new Color(1f, 1f, 1f, 1f);
        ...
        /// 分隔线颜色
        /// </summary>
        public static readonly Color SEPARATOR_COLOR = new Color(0.6f, 0.6f, 0.6f, 0.3f);
        
        /// <summary>
        /// 背景半透明颜色（黑色）
        /// </summary>
        public static readonly Color BACKGROUND_DARK = new Color(0, 0, 0, 0.7f);
        
        /// <summary>
        /// 面板背景颜色（深灰色）
        /// </summary>
        public static readonly Color PANEL_BACKGROUND = new Color(0.1f, 0.1f, 0.1f, 0.95f);
        
        /// <summary>
        /// 复选框背景颜色（未选中）
        /// </summary>
        public static readonly Color CHECKBOX_BACKGROUND_UNCHECKED = new Color(0.15f, 0.15f, 0.15f, 1f);
        
        /// <summary>
        /// 复选框背景颜色（选中）
        /// </summary>
        public static readonly Color CHECKBOX_BACKGROUND_CHECKED = new Color(0.18f, 0.32f, 0.18f, 1f);
        
        /// <summary>
        /// 复选框勾选标记颜色
        /// </summary>
        public static readonly Color CHECKBOX_CHECKMARK = new Color(0.35f, 0.95f, 0.35f, 1f);
        
        /// <summary>
        /// 复选框边框颜色（未选中）
        /// </summary>
        public static readonly Color CHECKBOX_BORDER_UNCHECKED = new Color(0.45f, 0.45f, 0.45f, 1f);
        
        /// <summary>
        /// 复选框边框颜色（选中）
        /// </summary>
        public static readonly Color CHECKBOX_BORDER_CHECKED = new Color(0.45f, 0.85f, 0.45f, 1f);
        
        /// <summary>
        /// 按钮颜色 - Primary
        /// </summary>
        public static readonly Color BUTTON_PRIMARY = new Color(0.2f, 0.5f, 0.8f, 1f);
        
        /// <summary>
        /// 按钮颜色 - Secondary
        /// </summary>
        public static readonly Color BUTTON_SECONDARY = new Color(0.3f, 0.3f, 0.3f, 1f);
        
        /// <summary>
        /// 按钮颜色 - Success
        /// </summary>
        public static readonly Color BUTTON_SUCCESS = new Color(0.2f, 0.5f, 0.2f, 1f);
        
        /// <summary>
        /// 按钮颜色 - Danger
        /// </summary>
        public static readonly Color BUTTON_DANGER = new Color(0.5f, 0.2f, 0.2f, 1f);
        ...
        /// 阴影颜色
        /// </summary>
        public static readonly Color SHADOW_COLOR = new Color(0, 0, 0, 0.8f);
